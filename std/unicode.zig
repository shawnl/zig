...
pub fn isValidUnicode(c: u32) UnicodeError!void {
    return switch (c) {
    0x0000...0xd7ff => void,
    0xd800...0xdfff => error.UnicodeSurrogateHalf,
    0xe000...0x10ffff => void,
    0x110000...0xffffffff => error.UnicodeCodepointTooLarge,
    };
}

/// Returns how many bytes the UTF-8 representation would require
/// for the given codepoint.
pub fn utf8CodepointSequenceLength(c: u21) Utf8Error!u3 {
...
pub fn utf8Encode(c: u21, out: []u8) Utf8Error!u3 {
